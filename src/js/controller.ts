...
export default class Controller {
  protected _activeRoute: any;
  protected _lastActiveRoute: any;
  ...
  constructor(
    ...
    view.bindToggleItem((id: any, completed: any) => {
   ...
   * @param {!number} id ID of the Item in edit
   */
  editItemCancel(id: any) {
    this.store.find({id}, (data: any) => {
   ...
   */
  toggleCompleted(id: any, completed: any) {
  ...
  toggleAll(completed: any) {
    this.store.find({completed: !completed}, (data: any) => {
      for (let {id} of data) {
        this.toggleCompleted(id, completed);
      }
    });
  ...
  _filter(force: any) {
    ...
    if (force || this._lastActiveRoute !== '' || this._lastActiveRoute !== route) {
      ...
      this.store.find(query, this.view.showItems.bind(this.view));
      /* jscs:enable disallowQuotedKeysInObjects */
    }

    this.store.count((total: any, active: any, completed: any) => {
