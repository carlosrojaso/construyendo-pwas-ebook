...
export default class View {
  ...
  protected $toggleAll: any;
  protected $clearCompleted: any;
  protected $newTodo: any;
  protected $main: any;
  protected $todoItemCounter: any;
  /**
  ...
  constructor(
    ...
    $delegate(this.$todoList, 'li label', 'dblclick', ({target}: any) => {
   ...
   */
  setClearCompletedButtonVisibility(visible: any) {
   ...
   */
  setCompleteAllCheckbox(checked: any) {
   ...
   */
  setItemComplete(id: any, completed: any) {
  ...
  bindAddItem(handler: any) {
    $on(this.$newTodo, 'change', ({target}: any) => {
  ...
  bindToggleAll(handler: any) {
    $on(this.$toggleAll, 'click', ({target}: any) => {
  ...
  bindRemoveItem(handler: any) {
    $delegate(this.$todoList, '.destroy', 'click', ({target}: any) => {
  ...
  bindToggleItem(handler: any) {
    $delegate(this.$todoList, '.toggle', 'click', ({target}: any) => {
  ...
  bindEditItemSave(handler: any) {
    $delegate(this.$todoList, 'li .edit', 'blur', ({target}: any) => {
    ...
    $delegate(this.$todoList, 'li .edit', 'keypress', ({target, keyCode}: any) => {
  ...
  bindEditItemCancel(handler: any) {
    $delegate(this.$todoList, 'li .edit', 'keyup', ({target, keyCode}: any) => {
